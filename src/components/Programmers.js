...
export default function Programmers() {
  ...
  const [programmers, setProgrammers] = useState(listOfAwesome); //array of objects
  const [featuredId, setFeaturedId] = useState('');  //ID of selected programmer
  ...
  const getNameOfFeatured = () => {
    ...
    return programmers[featuredId].name;
